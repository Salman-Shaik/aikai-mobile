    ...
    <View style={styles.subscriptions}>
      ...
      <View style={styles.subscriptionContainer}>
        ...
        >
          ...
          >
            <Text style={isFree() ? styles.selectedSubscriptionType : styles.subscriptionType}>Free</Text>
            <Text style={isFree() ? styles.selectedSubscriptionFeatures : styles.subscriptionFeatures}>
              Limited Favorites, Limited Watchlist, Limited Suggestions
            </Text>
            <Text style={isFree() ? styles.selectedSubscriptionPrice : styles.subscriptionPrice}>₹0 / Unlimited</Text>
          </Pressable>
        </View>
        <View
          style={
        ...
        >
          ...
          >
            <Text style={isPremium() ? styles.selectedSubscriptionType : styles.subscriptionType}>Premium</Text>
            <Text style={isPremium() ? styles.selectedSubscriptionFeatures : styles.subscriptionFeatures}>
              Unlimited Favorites, Unlimited Watchlist, Unlimited Everything.
            </Text>
            <Text style={isPremium() ? styles.selectedSubscriptionPrice : styles.subscriptionPrice}>₹49 / Year</Text>
          </Pressable>
        </View>
      </View>
    </View>
